                        ...
                        <div class="mt-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="assets/media/svg/brand-logos/plurk.svg" alt="" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="assets/media/svg/brand-logos/figma-1.svg" alt="" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="assets/media/svg/brand-logos/vimeo.svg" alt="" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
            ...
            <div class="col-xl-8">
                ...
                <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                    <div class="col-xl-3">
                        ...
                        <div class="card h-150px bgi-no-repeat bgi-size-cover card-xl-stretch"
                        ...
                        <div class="row gx-5 gx-xl-8">
                            ...
                            <div class="col-xxl-6">
                                ...
                                <a href="#" class="card card-xxl-stretch bg-body">
                                    <!--begin::Body-->
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <i class="ki-duotone ki-rocket text-success fs-2hx ms-n1 flex-grow-1"><span
                        ...
                        <div class="card h-100 bgi-no-repeat bgi-size-cover card-xl-stretch mb-5 mb-xl-8"
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href='#' class="text-warning fw-semibold" data-bs-toggle="modal"
                                    ...
                                    Create Report
                                    <i class="ki-duotone ki-arrow-right fs-2 text-warning"><span
                                            class="path1"></span><span class="path2"></span></i>
                                </a>
                                <!--end::Link-->
                            </div>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_646f6366a4949" data-allow-clear="true">
                                                <option></option>
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-p pb-0">
                            <div class="d-flex flex-stack flex-wrap">
                                <div class="me-2">
                                    <a href="#" class="text-dark text-hover-primary fw-bold fs-3">Generate
                                        Reports</a>
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                                <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Emma
                                    Smith</a>
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                                <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Sean
                                    Bean</a>
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                                <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Brian
                                    Cox</a>
                        ...
                        <div class="d-flex align-items-center ">
                            ...
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                                <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Dan
                                    Wilson</a>
